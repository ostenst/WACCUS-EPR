...
def estimate_CAPEX(mcaptured, x):
    ...
    print("CELSIO method yields:",x["CAPEX_ref"] * (65*8000/1000 / x["captured_ref"]) ** x["k"] *x["CEPCI"] /1000, " MEUR")
    CAPEX *= 1 + x["FOAK"]
...
def plan_CCU(plant, x, plot_single=False):
    ...
    print("CAC:", CAC)
    print("levelized_CAPEX:", levelized_CAPEX)
    print("levelized_CAPEX_H2:", levelized_CAPEX_H2)
    print("levelized_CAPEX_synthesis:", levelized_CAPEX_synthesis)
    print("levelized_OPEXfix:", levelized_OPEXfix)
    print("levelized_OPEX_H2:", levelized_OPEX_H2)
    print("levelized_OPEX_synthesis:", levelized_OPEX_synthesis)
    print("levelized_CAPEX_CO2_comp:", levelized_CAPEX_CO2_comp)
    print("levelized_CAPEX_H2_comp:", levelized_CAPEX_H2_comp)
...
def WACCUS_EPR( 
    ...
    CAPEX_ref = 3550 * 87,  # [MNOK] -> [kEUR] NOTE: can pick other CELSIO CAPEX from source:[Gassnova, Demonstrasjon av Fullskala CO2-Håndtering - Rapport for Avsluttet Forprosjekt]
    CAPEX_H2_ref = 550, # [kEUR/MWe] [Danish Agency Excel Renewable Fuels AEC100MW]
    CAPEX_synthesis_ref = 1.8749, # [MEUR] check units! Danish Renewable Fuels PDF has a power function of CAPEX_synthesis. Fig4, p.186.
    dr = 0.075,
    t = 25,
    FOAK = 1,      # [-] [Beiron, 2024] applies to CO2 capture and conditioning 
    CEPCI = 900/600, # University Manchester

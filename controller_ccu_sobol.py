...
parameter_labels = {
    ...
    "OPEXfix": "Fixed OPEX [%CAPEX/year]",
    "camine": "camine",
    "capture_rate": "capture_rate",
    "carbon_change": "carbon_change",
    "celc": "Electricity price [EUR/MWh]",
    "cfraction": "Carbon content [kgC/kgplastic]",
    "cheat": "cheat",
    "circulated": "circulated",
    "dr": "dr",
    "gothenburg": "Gothenburg",
    "heat_optimism": "Heat recovery [%]",
    "k": "k",
    "mKN39": "mKN39",
    "malmo": "malmo",
    "mbag": "mbag",
    ...
    "pmethanol": "Price methanol [EUR/t]",
    "q_distill": "q_distill",
...
plt.savefig("results/fig5_sobol_ccu.png", dpi=300, bbox_inches="tight")
plt.show()
"""Sobol sensitivity for WACCUS-EPR Replacement (EMA + SALib)."""
...
EPR_DESIGN = "Replacement"
DESIGN_SLUG = "replacement"
...
model = Model("WACCUSEPRReplacementSobol", function=ema_WACCUS_EPR)

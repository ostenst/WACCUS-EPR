...
experiments = pd.read_csv('experiments_ccs.csv')
outcomes_df = pd.read_csv('outcomes_ccs.csv')
...
plt.tight_layout()
plt.savefig('fig1_ccs.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('fig1_increases.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('fig1_fund.png', dpi=300, bbox_inches='tight')
plt.show()
